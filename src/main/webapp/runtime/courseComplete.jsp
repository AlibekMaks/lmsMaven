...
<script language="JavaScript">
        ...
        try{
            ctrl = window.opener.top.frames['LMSFrame'].document.getElementById("control").value;
        } catch (e){
            ctrl = window.top.frames['LMSFrame'].document.getElementById("control").value;
        }
        ...
        window.top.frames['LMSFrame'].document.getElementById("next").style.visibility = "hidden";
        window.top.frames['LMSFrame'].document.getElementById("previous").style.visibility = "hidden";
        window.top.frames['LMSFrame'].document.getElementById("suspend").disabled = false;
        window.top.frames['LMSFrame'].document.getElementById("suspend").style.visibility = "hidden";
        window.parent.frames['code'].document.location.href = "code.jsp";
        window.top.frames['LMSFrame'].document.getElementById("quit").disabled = false;
        window.top.frames['LMSFrame'].document.getElementById("quit").style.visibility = "hidden";
