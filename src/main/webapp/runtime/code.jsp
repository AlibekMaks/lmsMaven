...
<%
        ...
        && (!( courseID.equals("")) ) && (control.equals("true")) )
   {
      ...
      // replaced by Topa
      FileInputStream in = 
         new FileInputStream( Constants.getUsersInfoDirectory() + File.separator + userID +
            ...
            {    toc_item =  (ADLTOC)TOCList.elementAt(j);
                    ...
                    (toc_item.mID != null) )
               {
                ...
                current_vector.
                  ...
                  if (bool_obj.valueOf(toc_item.mIsCurrent)){
                  System.out.println("Cuurent node is " + toc_item.mTitle);
                  }
