...
<%
   ...
   ***************************************************************************/
   ...
   {
      request_type = "sequencingEngine.jsp?scoID="+requestedSCO + "&nocache=" + Math.round(Math.random()*10000000);
   } 
   else if ( (! (buttonType == null) ) && ( buttonType.equals("next") ) )
   {       
      request_type = "sequencingEngine.jsp?button=next" + "&nocache=" + Math.round(Math.random()*10000000);
   }
   else if ( (! (buttonType == null) ) && ( buttonType.equals("prev") ) )
   {
      request_type = "sequencingEngine.jsp?button=prev" + "&nocache=" + Math.round(Math.random()*10000000);
   }
    ...
    ***************************************************************-->
    <script language="javascript">       
       function launchItem(launch)
	   {
               ...
               // alert("pleaseWait.jsp launch = " + launch);
