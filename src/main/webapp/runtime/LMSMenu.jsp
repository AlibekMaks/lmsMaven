...
%>
    ...
    <tr>
       <td>
          <a href="/adl/LMSCourseAdmin?type=<%= ServletRequestTypes.VIEW_REG_COURSE %>&userId=<%= userid %>&nocache=<%=Math.round(Math.random()*10000000)%>">
...
%>
    ...
    <tr>
       <td>
        ...
        <tr>
       <td>
          <a href="../import/choseMultipleFilesImport.jsp">Import Multiple Courses</a>
       </td>
    </tr>
    <tr>
       <td>
