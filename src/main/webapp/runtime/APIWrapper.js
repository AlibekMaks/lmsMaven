...
function findAPI(win){
    ...
    /*alert("function findAPI(win), number of tries="+findAPITries+" \r\n" +
            " win.API_1484_11="+win.API_1484_11+",\r\n "+
            " win.parent=" + win.parent + " \r\n "+
            " win.parent.API_1484_11 =" + win.parent.API_1484_11);
      */
    ...
    /*if (navigator.appName.indexOf('Netscape') >= 0) {
        if (showMessages){
            alert("Found out that browser is Netscape");
        }
...
function getAPI(){
   ...
   if ((theAPI == null) && (window.opener != null) && (typeof(window.opener) != "undefined"))
   {
       ...
       //document.top.frames.mylog.innerHTML += "window.opener<br>";
      theAPI = findAPI(window.opener);
      // alert("got api from window.top.opener");
   }
