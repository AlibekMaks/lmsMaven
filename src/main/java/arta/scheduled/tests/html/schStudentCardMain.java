...
public class schStudentCardMain extends PageContentHandler {
    ...
    public schStudentCardMain(int lang, ServletContext servletContext, SearchParams params,
    ...
    public void getMainPart(PrintWriter pw) {
        new Parser(new FileReader("students/card.txt").read(servletContext), pw,
                new schStudentCard(servletContext, lang, message, student, params)).parse();
    }
