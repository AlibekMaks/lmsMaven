...
public class schStudentCard extends TemplateHandler {
    ...
    public schStudentCard(ServletContext servletContext, int lang, Message message, Student student, SearchParams params) {
