...
import arta.filecabinet.html.students.StudentCardMain;
...
public class StudentServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            student.setDepartmentID(extractor.getInteger(request.getParameter("department")));


            Message message = new Message();
            student.save(message,  lang,  params, person.getPersonID());

            new PageGenerator().writeHtmlPage(new StudentCardMain(lang, getServletContext(), params,
