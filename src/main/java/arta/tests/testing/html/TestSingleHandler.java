...
public class TestSingleHandler extends TemplateHandler {
    ...
    public TestSingleHandler(StringTransform trsf, int lang) {
        this.trsf = trsf;
        this.lang = lang;
    }
    ...
    public void replace(String name, PrintWriter pw) {
        if (name.equals("testID")){
            ...
            pw.print("<a href=\"testsfortesting?testID="+test.testID+"&option=-1&"+
