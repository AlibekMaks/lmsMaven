 ...
 */
public class AddedTestsHandler extends TemplateHandler {
    ...
    public AddedTestsHandler(int lang, Testing testing, ServletContext servletContext,
                             Message message) {
        this.lang = lang;
    ...
    public void replace(String name, PrintWriter pw) {
        if (name.equals("page header")){
            ...
            new Parser(new FileReader("testing/testing.card.options.html").read(servletContext),
                    pw, new TestingOptionsHandler(lang, testing,
            ...
            StringBuffer template = new FileReader("testing/added.test.single.txt").read(servletContext);
            TestSingleHandler handler = new TestSingleHandler(trsf, lang);
