...
public class AttestatTestReportBuilder {
    ...
    public StringBuffer build(Testing testing, Student student, int lang){
        ...
        str.append("&nbsp;");
        str.append(student.getBirthdate().getInputValue());
		// str.append("____________________ &nbsp;");
...
//    	str.append("</tr>");
    	...
    	str.append("</td>");
    	str.append("<td width=\"15%\">" +testing.chairman);
    	str.append("</td>");
    	str.append("<td width=*>");
    	str.append("</td>");
    	...
    	str.append("<td>");
    	str.append("</td>");
    	str.append("<td style=\"border-top: 1px solid black;\"><span style=\"font-size:0.75em;\">"+// signature +
                "</span>");
    ...
    //	str.append("</td>");
        str.append("<td>");
        str.append("</td>");
// str.append("<td style=\"border-top: 1px solid black;\"><span style=\"font-size:0.75em;\">"+testing.chairman+"</span>");
//    	str.append("</td>");
    	str.append("<td>");
    	str.append("</td>");
    	str.append("</tr>");
    	...
    	str.append("<td>");
    	str.append("</td>");
    	str.append("<td >"+testing.vicechairman);
    	str.append("</td>");
    	str.append("<td>");
    	str.append("</td>");
    	str.append("</tr>");
...
//    	str.append("</td>");
        ...
        str.append("<td>");
        str.append("</td>");
        str.append("<td>"+testing.secretary);
        str.append("</td>");
