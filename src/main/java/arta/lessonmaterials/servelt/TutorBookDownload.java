...
import arta.lessonmaterials.logic.TutorBookResource;
...
public class TutorBookDownload extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       /*     if (!Access.isUserAuthorized(session)){
            ...
            TutorBookResource bookResource = new TutorBookResource(bookID);
