...
public class MDValidator extends ADLSCORMValidator
{
   ...
   * 
   */
  private List mLifecycleContributeVocabList;
  
  /**
   * The application profile type being tested against
   * <ul>
  ...
  public boolean validate( String iXMLFileName )
  {
     ...
     mLogger.info( "INFO: Testing the Metadata XML Instance for " +
         "Well-formedness");

     // Decode any Unicode encoded characters in the filename
     decodeHandler decoder = new decodeHandler( iXMLFileName, "UTF-8" );
     decoder.decodeName();
     iXMLFileName = decoder.getDecodedFileName();
     ...
     mLogger.info( "INFO: Testing the Metadata XML Instance for Validity" +
                           ...
                           boolean iDidValidationToSchemaPass )
  {
     ...
     mLogger.info( "INFO: Testing the Metadata XML Instance for Well-" +
         "formedness");
                                  ...
                                  int iMinRule )
  {
               ...
               iDataType.equalsIgnoreCase("duration") )
     {
        ...
        msgText = Messages.getString("MDValidator.48", iCurrentChildName,
                                                       iDataType); 
        mLogger.info( "INFO: " + msgText );
        DetailedLogMessageCollection.getInstance().addMessage( new LogMessage(
                                                 MessageType.INFO,
              ...
              if ( (iCurrentChild.getParentNode()).getLocalName().equals("general") ) 
              {
                 if (  nodes.item(0).getNodeValue() != null ) 
                 {
                    if ( nodes.item(0).getNodeValue().equals("none") )
                    {
                       ...
                       msgText = Messages.getString("MDValidator.315",
               ...
               else
               {
                  ...
                  msgText = Messages.getString("MDValidator.316",
                                               nodes.item(0).getNodeValue() );
         ...
         case Node.ELEMENT_NODE:
         {
            ...
            if ( children != null )
            {
               ...
               else if (parentNodeName.equalsIgnoreCase("metaMetadata") )
               {
                  ...
                  {
                     int metaMetadataChildrenLength = 
                                       metaMetadataChildren.getLength();
                     for ( int i = 0; i < metaMetadataChildrenLength; i++ )
                     {
                        Node currentChild = metaMetadataChildren.item(i);
                        if ( currentChild.getLocalName().equals(
                                                             "metadataSchema") )
                        {
               ...
               {
                  result = checkForMandatory( iTestSubjectNode, "copyrightAndOtherRestrictions" )
                           && result;
               ...
               for ( int z = 0; z < numChildren; z++ )
               {
                  ...
                  if(!lastChildChecked.equals(currentChildName) || 
                              lastChildChecked.equals("") )
                  {
                     ...
                     msgText = Messages.getString("MDValidator.70",
                                              currentChildName); 
                     mLogger.info( "INFO: " + msgText );
                     DetailedLogMessageCollection.getInstance().addMessage( 
                                                          new LogMessage(
...
//    mMetadataSchemaTracked will be 'true' and fall to the else
                                        ...
                                        int iMinRule )
   {
      ...
      if ( iSPMRule != -1 )
      {
         ...
         {
            msgText = Messages.getString("MDValidator.154", iElementName,
                                         new Integer(iSPMRule).toString() ); 
            mLogger.info( "WARNING: " + msgText );
            DetailedLogMessageCollection.getInstance().addMessage( new LogMessage(
                                                            MessageType.WARNING,
                                                            msgText ) );
 ...
 */
                                      ...
                                      int iMaxRule, String iElementName )
   {
      ...
      if ( (iMinRule != -1) && (iMaxRule != -1) )
      {
         ...
         else
         {
            ...
            {
               msgText = Messages.getString("MDValidator.208", iElementName, 
                  iMaxRule ); 
               mLogger.info( "WARNING: " + msgText );
               DetailedLogMessageCollection.getInstance().addMessage( 
                                    ...
                                    String iPath )
   {
      ...
      if (currentLangstringElementName != null)
      {
          ...
          boolean stringElementExists = 
              checkForMandatory(iCurrentLangstringElement, "string");
          ...
          if ( stringElementExists )
          {
             ...
             Vector childNodes = DOMTreeUtility.getNodes( iCurrentLangstringElement,
                                                          "string" );
    
             //test multiplicity of language attribute
             for ( int i = 0; i < childNodes.size( ); i++ )
             {
                if(((Node)childNodes.elementAt(i)).getLocalName().equals("string"))
                {
                   Node stringNode = (Node)childNodes.elementAt(i);
                   //look for the attribute of this element
                   NamedNodeMap attrList = 
                                  ((Node)childNodes.elementAt(i)).getAttributes( );
                   ...
                   //get the spm rule and convert to an int
                    ...
                    spmRule = Integer.parseInt(
                             mMetadataRulesValidator.getRuleValue(
                                         currentLangstringElementName,
                                         iPath,
                                         "spm") );
                    int parentMinRule = Integer.parseInt(
                              mMetadataRulesValidator.getRuleValue(
                               currentLangstringElementName,iPath, "min") );
                   ...
                   result = checkSPMConformance( langstringElement,
                                                 stringValue,
                                                 spmRule, parentMinRule ) && result;
                 }
             }
          }
          else
   ...
   private boolean checkMetadataSchema()
   {
      ...
      if ( foundLOMSchema )
      {
          msgText = Messages.getString("MDValidator.251", "LOMv1.0", 
             currentElementName) ; 
          mLogger.info( "PASSED: " + msgText );
          DetailedLogMessageCollection.getInstance().addMessage( new LogMessage(
             MessageType.PASSED, msgText ) );
      ...
      {
          msgText = Messages.getString("MDValidator.253", "LOMv1.0", 
             currentElementName) ; 
          mLogger.info( "FAILED: " + msgText );
          DetailedLogMessageCollection.getInstance().addMessage( new LogMessage(
             MessageType.FAILED, msgText ) );
      ...
      if ( foundADLSchema )
      {
          msgText = Messages.getString("MDValidator.251", "ADLv1.0", 
             currentElementName) ; 
          mLogger.info( "PASSED: " + msgText );
          DetailedLogMessageCollection.getInstance().addMessage( new LogMessage(
             MessageType.PASSED, msgText ) );
      ...
      {
         msgText = Messages.getString("MDValidator.253", "ADLv1.0", 
            currentElementName) ; 
         mLogger.info( "FAILED: " + msgText );
         DetailedLogMessageCollection.getInstance().addMessage( new LogMessage(
            MessageType.FAILED, msgText ) );
          ...
          for ( int i=0; i < numChildren; i++ )
          {
                  ...
                  ( currentChildName.equals("duration") ) )
             {
                ...
                result = checkSPMConformance( currentChildName,
                                              currentChildValue,
                                              spmRule, minRule ) && result;

                // peform valiation to the ISO 8601 format
                if ( currentChildName.equals("dateTime") )
                {
                   DateTimeValidator dTimeVal = new DateTimeValidator( true );
                
                   int intResult = dTimeVal.validate( currentChildValue );
                   if (intResult == 0)
                   {
                      // no error
                      msgText = Messages.getString("MDValidator.319",
                                                     currentChildValue, 
                                                     "dateTime" );
                      mLogger.info( "PASSED: " + msgText );
                      DetailedLogMessageCollection.getInstance().addMessage(
                   ...
                   else
                   {
                      //  error, value is not a valid dateTime value
                       msgText = Messages.getString("MDValidator.320",
                                                currentChildValue, "dateTime" );
                      mLogger.info( "FAILED: " + msgText);
                      DetailedLogMessageCollection.getInstance().addMessage(
                                      new LogMessage(MessageType.FAILED, msgText));
                ...
                else
                {
                   ...
                   {
                      // no error
                       msgText = Messages.getString("MDValidator.321",
                                                      currentChildValue, 
                                                      "duration" );
                      mLogger.info( "PASSED: " + msgText);
                      DetailedLogMessageCollection.getInstance().addMessage(
                   ...
                   {
                      // type mismatch error, value is not a valid language code
                       msgText = Messages.getString("MDValidator.322",
                                                      currentChildValue, 
                                                      "duration" );
                      mLogger.info( "FAILED: " + msgText);
                      DetailedLogMessageCollection.getInstance().addMessage(
       ...
       if ( descriptionExists )
       {
          ...
          for ( int i=0; i < numChildren; i++ )
          {
             ...
             if ( currentChildName.equals("description") )
             {
               ...
               msgText = Messages.getString("MDValidator.43", 
                                            currentChildName ); 
               mLogger.info( "INFO: " + msgText );
               DetailedLogMessageCollection.getInstance().addMessage( 
                  new LogMessage(MessageType.INFO, msgText));
       ...
       if ( result )
       {
          ...
          for ( int i=0; i < numVocabChildren; i++ )
          {
             ...
             if ( currentVocabChildName.equals("source") )
             {
                ...
                {
                   msgText = Messages.getString("MDValidator.284",
                                                iElementName ); 
                   mLogger.info( "WARNING: " + msgText );
                   DetailedLogMessageCollection.getInstance().addMessage(
                                 new LogMessage( MessageType.WARNING, msgText ) );
             ...
             else if ( currentVocabChildName.equals("value") )
             {
                ...
                if ( vocabularyElementName.equalsIgnoreCase("role") &&
                     iPath.equals("lom.lifeCycle.contribute") )
                {
    ...
    private void checkNameTypePair( String iCurrentChildName )
    {
       ...
       if ( iCurrentChildName.equalsIgnoreCase("name") )
       {
          if ( !mTypeValue.equals("") )
          {
             ...
             {
                msgText = Messages.getString("MDValidator.302",
                                             iCurrentChildName); 
                mLogger.info( "WARNING: " + msgText );
                DetailedLogMessageCollection.getInstance().addMessage( 
                   new LogMessage(MessageType.WARNING, msgText));
    ...
    /**
     * This method assists with enforcing the Best Practice of SCORM recommending 
     * that the author of the SCORM Content Model Component be identified.  This
     * method throws a best practice warning if the lifeCycle.contribute.role
     * element does not contain at least one vocabulary value of "author" 
     */
   private void checkLifecycleContributeRole()
    {
       String msgText = "";
       if( !mLifecycleContributeVocabList.isEmpty() )
       {
          boolean result = false;
          if ( mLifecycleContributeVocabList.contains("author") )
          {
             result = true;
          }
          ...
          if( !result )
          {
             msgText = Messages.getString("MDValidator.325"); 
             mLogger.info( "WARNING: " + msgText );
             DetailedLogMessageCollection.getInstance().addMessage( 
                      new LogMessage(MessageType.WARNING, msgText));
          }
       ...
       {
          // lifeCycle.contribute did not exist at all so best practice warning
          // should be thrown
          msgText = Messages.getString("MDValidator.325"); 
          mLogger.info( "WARNING: " + msgText );
          DetailedLogMessageCollection.getInstance().addMessage( 
    ...
    */
   private void checkThatChildrenCoExist( Node iParentNode, String iParentName, 
                                           String iChild1, String iChild2 )
    {
