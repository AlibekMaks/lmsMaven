...
public class CPValidator extends ADLSCORMValidator
{
   ...
   private boolean mZipExtractionResult = true;
    ...
    /**
     * Эта переменная дописана мной. Создана для того чтобы
     * каждый курс распаковывался в свою собственную директорию.
     * Для того чтобы обеспечить импорт нескольких курсов одновременно
     * Commented by Topa
     */
    ...
    * @param courseIdentifier - айдишник загружаемого курса
    */
    public CPValidator(String iEnvironmentVariable, String courseIdentifier){
    ...
    */
    public boolean validate(String iFileName, String iTestType, String iApplicationProfileType, boolean iManifestOnly){
        ...
        if( iTestType.equals("pif") ) {
            ...
            mBaseDirectory = Constants.getCousreUnpackTemporaryDirectory(courseIdentifier) + File.separator;
        } else {
    ...
    *
    *  Этот метод распаковывает курс во временную директорию,
    *  /PackageImport
    *  todo необходимо изменить временную директорию!!
    *
    ...
    */
    private String importContentPackage(String iPIF) {
        ...
        String extractDir = Constants.getCousreUnpackTemporaryDirectory(courseIdentifier) + File.separator;
      ...
      else
      {
         ...
         try
         {
            ...
            if( fileToFind.isFile() )
            {
               ...
               tempStr = tempStr.substring(tempStr.indexOf(Constants.getUnpackDirecoty(courseIdentifier) + File.separator) +
                       (Constants.getUnpackDirecoty(courseIdentifier) + File.separator).length(), tempStr.length());
