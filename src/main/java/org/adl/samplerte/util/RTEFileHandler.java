...
public class RTEFileHandler {
    ...
    public RTEFileHandler() {
        //mSampleRTERoot = File.separator + "SCORM3EDSampleRTE102Files";
    }
    ...
    public void initializeStateFile(String iNumAttempt, String iUserID,
        ...
        try {
            ...
            String userDir = Constants.getUsersInfoDirectory() + File.separator + iUserID +
     ...
     */
    public void deleteCourseFiles(Object iDeleteCourseID, Object iUserID) {
        try {
            String userDir = Constants.getUsersInfoDirectory() + File.separator + iUserID +
     ...
     * directory.
     */
    public void deleteTempUloadFiles(String courseIdentifier) {
        try {
            //String tempDir = mSampleRTERoot + File.separator + "tempUploads";
            String tempDir = Constants.getTempZipFilesDirectory(courseIdentifier);
        ...
        try {
            ...
            String sqlSelectSSP_BucketAllocateTbl =
                    "SELECT * FROM ssp_bucketallocatetbl" +
                            " WHERE CourseID = ? AND Persistence <> ?".toLowerCase();
            ...
            while (rsSSP_BucketAllocateTbl.next()) {
                ...
                bucket = Constants.getUsersInfoDirectory() + File.separator + learnerID +
    ...
    public void deleteCourseSSPData(String iCourseID, String iLearnerID) {
        ...
        try {
            ...
            while (rsSSP_BucketAllocateTbl.next()) {
                ...
                bucket = Constants.getUsersInfoDirectory() + File.separator + iLearnerID +
                        File.separator + bucketID + iCourseID;
