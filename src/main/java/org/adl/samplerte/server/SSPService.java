...
public class SSPService 
{
    ...
    */
   //private static String SRTEFILESDIR = "SCORM3EDSampleRTE102Files";
   ...
   public int addBucket(BucketProfile iBucketProfile)
   {
      ...
      try
      {
         ...
         sspRequest.mManagedBucketIndex = 0;
          ...
          System.out.println("URL servletLocation = new URL( \"http://localhost/adl/SSPServer\" )");

         URL servletLocation = new URL( "http://localhost/adl/SSPServer" );
         ...
         if ( errorCode != 0 )
         {
            String bucket = Constants.getUsersInfoDirectory() +
